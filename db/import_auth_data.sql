...
-- Insert users
REPLACE INTO `users` (`id`, `username`, `password`, `password_hash`, `email`, `full_name`, `phone_number`, `role`, `enabled`, `branch_id`, `created_at`, `updated_at`, `note`) VALUES
...
(7, 'Tutl', '$2a$10$0P6niSx/VIjhEfnjFVv.cOWuRpb.WTEhAvCEdTzUO9BFyuDVwp2je', '$2a$10$0P6niSx/VIjhEfnjFVv.cOWuRpb.WTEhAvCEdTzUO9BFyuDVwp2je', 'Tutl@gmail.com', 'Trần Long Tú', '0866066043', 'EMPLOYEE', 1, NULL, '2026-01-03 21:57:14', '2026-01-27 08:36:31', NULL),
(8, 'TanBinh', '$2a$10$C2DybkhUAxwMFkLTSIVnteX834ZBW/Glnvg2OKPZxVzNZJvAYCIyW', '$2a$10$C2DybkhUAxwMFkLTSIVnteX834ZBW/Glnvg2OKPZxVzNZJvAYCIyW', 'tanbinh@gmail.com', 'Tấn Bình', '0866066042', 'OWNER', 1, 2, '2026-01-21 22:25:46', '2026-01-27 08:36:31', NULL);
